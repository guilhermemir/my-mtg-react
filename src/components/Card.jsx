    ...
    <div className="w-80 bg-white rounded-xl p-3 shadow-xl">
      ...
      <ul className="flex flex-wrap gap-1 mt-2 items-center">
        ...
        <li>
          <button
            type="button"
            class="border border-gray-700 bg-gray-700 text-white font-semibold rounded-md px-2 py-1 transition duration-300 ease select-none hover:bg-gray-800 focus:outline-none focus:shadow-outline"
          >
            +
          </button>
        </li>
        <li>
          <input
            ...
            id=""
            value={5}
            class="border border-gray-200 bg-gray-200 text-gray-700 w-12 rounded-md px-2 py-1 transition duration-300 ease select-none hover:bg-gray-300 focus:outline-none focus:shadow-outline"
          />
        </li>
        <li>
          <button
            type="button"
            class="border border-gray-700 bg-gray-700 text-white rounded-md px-2 py-1 transition duration-300 ease select-none hover:bg-gray-800 focus:outline-none focus:shadow-outline"
          >
            -
          </button>
        </li>
        <li>
          <button
            type="button"
            class="border border-red-500 bg-red-500 text-white rounded-md px-2 py-2 transition duration-300 ease select-none hover:bg-red-600 focus:outline-none focus:shadow-outline"
          >
            <svg
              class="w-4 h-4"
